   ...
   --------------------------------------------------------------------------------
                   README file for Autoprefixer Host for .NET v3.0.11
   ...
   RELEASE NOTES
   =============
   1. Added support of the Autoprefixer version 10.3.5.0;
   2. Now, when reading a script code from the embedded resources, caching is
      performed.
