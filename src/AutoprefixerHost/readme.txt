   ...
   --------------------------------------------------------------------------------
                   README file for Autoprefixer Host for .NET v1.1.0
   ...
   (https://github.com/postcss/autoprefixer) version 9.7.
   ...
   RELEASE NOTES
   =============
   1. Added support of the Autoprefixer version 9.7;
   2. Fixed a error leading to incorrect disposal.
